...
jupyter:
  ...
  kernelspec:
    ...
    language: python
    name: conda-env-522-group21-housing-py
---
...
This code applies the trained pipeline to predict housing prices values based on the features in the dataFrame containing new data <cite>@hastie2009</cite>. The predictions are stored in a new pandas DataFrame.
...
```{python}
# Display the predicted values dynamically
predictions_df['Predicted_Values']
```
